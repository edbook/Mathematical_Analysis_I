...
project = 'Mathematical Analysis I'
...
latex_documents = [
  ('index', 'StrfrigreiningI.tex', 'Stærðfræðigreining I Documentation',
   'Benedikt Steinar Magnússon', 'manual'),
]
...
man_pages = [
    ('index', 'strfrigreiningi', 'Stærðfræðigreining I Documentation',
